  ...
  return (
    <>
      <div className="mt-6 space-y-1">
        <h2 className="text-2xl font-semibold tracking-tight">Support/Resistance</h2>
        <p className="text-sm text-muted-foreground">
          S/R Finder is a powerful tool that helps you find support and resistance levels for any
          stock.
        </p>
      </div>
